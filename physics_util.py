...
def bounce(ball, terrain):
    ...
    div_vec_1 = pygame.math.Vector2(terrain.X[div_index], terrain.Y[div_index])
    div_vec_2 = pygame.math.Vector2(terrain.X[div_index + 1], terrain.Y[div_index + 1])
    div_vec = div_vec_1 - div_vec_2
    #agora eu vou pegar o vetor normal à reta que passa por div_vec_1 e div_vec_2
    normal_vec = pygame.math.Vector2(-(div_vec_2.y - div_vec_1.y), (div_vec_2.x - div_vec_1.x))
